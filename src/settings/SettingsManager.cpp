...
void SettingsManager::buildSchema()
{
    ...
    m_defs = {
        ...
        { QStringLiteral("editor.highlightActiveLine"), QStringLiteral("Editor"), QStringLiteral("Highlight active line"),
          QString(), T::Bool, true, {} },
        { QStringLiteral("completion.enabled"), QStringLiteral("Editor"), QStringLiteral("IntelliSense autocomplete"),
          QStringLiteral("Offline completion from document words, language keywords and snippets."), T::Bool, true, {} },
        { QStringLiteral("editor.vimMode"), QStringLiteral("Editor"), QStringLiteral("Vim keybindings"),
          QStringLiteral("Modal editing (normal / insert / visual). Disables Emacs mode."), T::Bool, false, {} },
        { QStringLiteral("editor.emacsMode"), QStringLiteral("Editor"), QStringLiteral("Emacs keybindings"),
          QStringLiteral("Emacs-style control keys. Disables Vim mode."), T::Bool, false, {} },
        // ---- AI (local models) ----
        { QStringLiteral("ai.endpoint"), QStringLiteral("AI"), QStringLiteral("Local model endpoint"),
          QStringLiteral("OpenAI-compatible endpoint (Ollama, LM Studio, llama.cpp). Local by default — nothing is sent to the cloud."), T::String, QStringLiteral("http://localhost:11434/v1"), {} },
        { QStringLiteral("ai.model"), QStringLiteral("AI"), QStringLiteral("Model name"),
          QStringLiteral("Model identifier used in chat requests."), T::String, QString(), {} },
        // ---- Tools ----
        { QStringLiteral("grpc.grpcurlPath"), QStringLiteral("Tools"), QStringLiteral("grpcurl path"),
          QStringLiteral("Full path to the grpcurl binary used by the gRPC panel (empty = auto-detect on PATH)."), T::String, QString(), {} },
        { QStringLiteral("debugger.gdbPath"), QStringLiteral("Tools"), QStringLiteral("Debugger path"),
          QStringLiteral("gdb or lldb-mi executable used by the debug panel (empty = auto-detect on PATH)."), T::String, QString(), {} },
